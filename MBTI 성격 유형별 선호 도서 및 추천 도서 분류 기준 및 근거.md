...
- 미래 가능성에 초점을 둔 책
- 판타지에 관한 내용이 담긴 책
- <b>(판타지 : 터무니없는 가상 세계에서 일이 벌어지거나, 일어날 수 없는 일들이 예상을 깨며 빈번히 일어나는 사건을 담은 문학 작품)</b>[^1] :new:
- <b>비현실적인 서사로 전개되는 책 (SF 등)</b> :new:
- <b>현실에서 존재할 수 없는 생물/물체가 존재하는 책 (유니콘, 요술봉 등)</b> :new:
- 망상, 상상, 공상을 즐기는 주인공의 이야기가 담긴 책
- <b>그리스 로마 신화, 삼국지 등 판타지 요소가 주 맥락이 되는 설화 책</b> :new:
...
- <b>내가 선택한 답을 맞았다/틀렸다로 정의할 수 있는 내용이 담긴 책 (수학적 요소 등)</b> :new:
